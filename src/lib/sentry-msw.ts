...
import type {
  SentryAutofixRunSchema,
  SentryAutofixRunStateSchema,
...
export const restHandlers = [
      ...
      return HttpResponse.json([
        {
          ...
          externalTeams: [],
          projects: [],
        } satisfies z.infer<typeof SentryTeamSchema>,
      ]);
    },
  ),
  http.get(
      ...
      return HttpResponse.json([
        {
          ...
          hasFlags: false,
          latestDeploys: null,
        } satisfies z.infer<typeof SentryProjectSchema>,
      ]);
    },
  ),
  http.post(
  ...
  http.post(
    ...
    () => {
      ...
      } satisfies z.infer<typeof SentryClientKeySchema>);
    },
  ),
  http.get(
        ...
        data: [
          {
            ...
            issue: "REMOTE-MCP-41",
          } satisfies z.infer<typeof SentryDiscoverEventSchema>,
        ],
        meta: {
          fields: {
            "issue.id": "integer",
  ...
  http.get(
    ...
    () => {
      ...
      } satisfies z.infer<typeof SentryEventSchema>);
    },
  ),
  http.get("https://sentry.io/api/0/issues/6507376925/autofix/", () => {
    return HttpResponse.json({
      run_id: 123,
    } satisfies z.infer<typeof SentryAutofixRunSchema>);
  }),
  ...
  http.post("https://sentry.io/api/0/issues/6507376925/autofix/", () => {
    ...
    } satisfies z.infer<typeof SentryAutofixRunStateSchema>);
  }),
];
