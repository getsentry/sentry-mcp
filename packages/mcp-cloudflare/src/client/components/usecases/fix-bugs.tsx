  ...
  return (
    <div className="p-4 sm:p-8 lg:border-r max-lg:border-b border-dashed border-white/10 overflow-hidden justify-end flex flex-col group relative">
      ...
      <div className="relative min-h-64 [mask-image:linear-gradient(to_bottom,rgba(0,0,0,1)_60%,rgba(0,0,0,0)_100%)] mb-auto">
        <div className="border rounded-2xl border-white/10 bg-[#201633] absolute top-0 left-0 bottom-0 right-8 translate-y-8 group-hover:translate-y-0 duration-200 ease-[cubic-bezier(0.175,0.885,0.32,1.275)]">
          <div className="flex items-center px-3.5 py-0.5 gap-1.5">
            ...
            <div className="rounded-lg border border-white/10 bg-white/5 px-2 py-1 text-xs truncate">
              <span className="relative block overflow-hidden">
                <div className="absolute inset-0 size-full bg-[#e1567c] -translate-x-full group-hover:translate-x-0 group-hover:duration-500 ease-[steps(20)]" />
        ...
        <div className="border rounded-2xl border-white/10 bg-[#160f24] absolute top-8 left-8 bottom-0 right-0 p-4 text-xs font-mono translate-y-8 group-hover:translate-y-0 duration-200 group-hover:delay-1000 ease-[cubic-bezier(0.175,0.885,0.32,1.275)]">
          &gt; fix&nbsp;
