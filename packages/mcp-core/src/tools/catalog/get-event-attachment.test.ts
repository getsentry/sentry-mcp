  ...
  it("lists attachments for an event", async () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      ...
      **SHA1:** abc123def456
      ...
      Use the Sentry tool \`get_event_attachment\`: search \`search_tools(query='get_event_attachment')\`, then call \`execute_tool\` with name \`get_event_attachment\` and arguments \`{"organizationSlug":"sentry-mcp-evals","projectSlug":"cloudflare-mcp","eventId":"7ca573c0f4814912aaa9bdc77d1a7d51","attachmentId":"123"}\`
