...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: [
      "Analyze an issue in Sentry, identify a root cause, Suggest a fix it.",
      "",
      "Use this tool when you need to:",
      "- Diagnose an issue to determine the root cause.",
      "- General a plan for fixing an issue.",
      "- Implement a fix for an issue.",
      "",
      "This operation may take some time, so you should call `get_root_cause_analysis_status()` to check the status of the analysis after you begin it.",
      "",
      "<examples>",
      "### Analyze and propose a fix for 'ISSUE-123' in Sentry",
      "",
      "```",
      "begin_root_cause_analysis(organizationSlug='my-organization', issueId='ISSUE-123')",
      "```",
      "</examples>",
      "",
      "<hints>",
  ...
  },
  {
    ...
    description: [
      ...
      "",
      "```",
      "get_autofix_state(organizationSlug='my-organization', issueId='ISSUE-123')",
      "```",
      "",
      "</examples>",
      "",
