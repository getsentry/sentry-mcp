...
1. **Install node and pnpm:**
   ...
   You can either install it your own way or use [devenv](https://github.com/getsentry/devenv) to perform an isolated install of node + pnpm:
...
3. **Create an OAuth App in Sentry** (Settings => API => [Applications](https://sentry.io/settings/account/api/applications/)):
