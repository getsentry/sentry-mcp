...
- `get_latest_base_snapshot` returns the latest baseline images for an app — useful for browsing what the current UI looks like or understanding baseline state during snapshot investigations.
